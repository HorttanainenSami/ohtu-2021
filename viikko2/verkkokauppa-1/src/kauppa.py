...
from viitegeneraattori import viitegeneraattori as dedault_viitegeneraattori



class Kauppa:
    def __init__(self, varasto=default_varasto, pankki=default_pankki, viitegeneraattori=dedault_viitegeneraattori):
